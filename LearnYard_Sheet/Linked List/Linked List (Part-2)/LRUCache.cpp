#include <bits/stdc++.h>
using namespace std;
//Least recently used meaning - esa item joki bohot samay se use na kiya gayaa ho
//isliye naye waale ko humesha front me daalenge

//Brute force (600ms waali approach)
// class LRUCache {
//     public:
